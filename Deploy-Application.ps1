...
Try {
	...
	[string]$appVendor = 'Posit'
	[string]$appName = 'Rstudio'
	[string]$appVersion = '2023.03.0-386'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'rstudio' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$envSystem32Directory\setx.exe" -Parameters "RSTUDIO_DISABLE_CHECK_FOR_UPDATES True /M" -WindowStyle "Hidden" -PassThru
		## Remove Desktop Link
		If (Test-Path "$env:Public\Desktop\R 4.2.2.lnk") {
			Remove-Item "$env:Public\Desktop\R 4.2.2.lnk" -Force
		}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'rstudio' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$envProgramFiles\Rstudio\Uninstall.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD4qp+sXVo0bNxz
# PQ+iDIUCezLCfkwC8FaPEcrbECjmJKCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgNvHYRyL/IRnp
# 0a53EDfDOHfRoXqPqa++7ry+L/glCBowDQYJKoZIhvcNAQEBBQAEggGAjNkOp/nW
# j6cBcigecWFn23P/7KNS87mENwTPi977MrPdKzHmIM5jIcqKEXuVT+KzVaYf7dr/
# /q/K/e6ZHhlA74GZs2FII1+pMDZzJLldIITi9hFRe1AEdcDLo6LTb/oJqTvRvf6I
# 8c2m6Cdxuo2VPUn8oSz7Y44dsHx2XqbicH/63ccgOD/qMLlkXi5GWsL+YgwPQcn9
# e7dRH+rIvSxmSVjcQfyrIp8lEoMF6Lcx0HgyQJlpiTFOFqBAxn7IbURUknqPSEO4
# QA/BBARSLDyZrggebPgv0iiR+6tokJ/md3MKnVty6aWKXSE2Oczk3biVEWzqRmPm
# AHYvu9hvM23NCXqddVgnPeSq2JAFTHA/0fwlZOdt3A4ZvMnhgbaoO3fPLnJjp5RK
# SzyCM7hWr45R+ZujuyF637mh26yptD5g4TwjL/2DKuijoW/2XbDEVaeyb/VYcA0g
# SU9aRA5Zbfm7I0TkENgVFIAoL8Izd4IWuWBfWuPaxItDi7g+GagjSW+QoYIDTDCC
...
# NzE5NDhaMD8GCSqGSIb3DQEJBDEyBDC4qsc6w3hvGbfoUFBlaGlm1TQ6qj40o9Yu
# V91ZwwqzQ6SafRA6ZRO0DYeM4wbQNTUwDQYJKoZIhvcNAQEBBQAEggIACIgXOaKe
# u2kXod7N1a+vmTjvLAIjLJ2T3a5CKD3OFzRO5kIHanyQM5zHRAXsJsHO3QV0J5gK
# pUp0e5mmjrkSrfq4M3wp+TYC3b4mpvYIe/OzJ2M2OL1MmUSrEmER++IJHVWuoGC2
# m53cKHLH7oEA/XjU4xac7+JO+3hcZu4+O0QkesYNDzPzkfE5F7jl76fZhdo6g4Ix
# zHM4yxRnlhI+NkFgXUDVC0UwbKYZU4IJ74e+lpXahekQDDrmwgmBfwbVJ4O/Ffgd
# bFWTsNdNVu6qaQrjbdA2knjsaYlZrqaT7hXZx1VqV9R/YwkbCUvNIGcGU13pN4Sy
# nVGaYqU5TS46tgOfAmhAsmb2uAMlaV3RdetD+doy8TU/RDDixob0m8JTOGSvhr7Q
# Ov6VsKZgnHqLUv9DmpwXbxNabTeMqj5S9C7mG52I0jiETEoAVwZwxTx2753fInIw
# /PeOiHOfJTxBWxk6exUliKOyKbQgmW0hiMBNX/2UGxVCLEck8h9pWORmxadLRCLO
# 1w3mouecdtn81roG1KiIzHhu9e+85+D5B88Iwb+ReZE6KadkGAR10e3SvSYAXS55
# NxJ/U9HL0xounNMletaqn4IhuE0WBOZyFUnaSZgynE8xLMbcdYow1ioYFi72PqPW
# 54BLyuKC6ZU0V1znEjEU56M1lL1zDI6oAp0=
